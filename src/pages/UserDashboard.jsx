            ...
            <div className="overview-section">
              ...
              <div className="stats-grid">
                <div className="stat-card">
                  ...
                  <div className="stat-value">{userData.testsCompleted}</div>
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-value">{Object.keys(userData.skillLevels).length}</div>
              ...
              <div className="skill-progress-section">
                ...
                <div className="skill-progress-grid">
                  {Object.entries(userData.skillLevels).map(([skill, level]) => (
